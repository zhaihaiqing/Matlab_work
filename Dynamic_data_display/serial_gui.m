...
% Last Modified by GUIDE v2.5 12-Oct-2019 17:05:48
...
%global Pitch;
global device_len;
%global DP_C;     %创建一个全局元胞数据，用于在edit text中显示多行
global ADC_Value;

clear global  ADC_Value;
device_len=50;
x_data=0;
x_lim=0;
RX_Count=0;
   ...
   %尝试打开串口
    if strcmp(get(gco,'string'),'打开串口')
        try
            ...
            addr=str2num(get(handles.edit12,'string'));
            Sampling_Time=str2num(get(handles.edit13,'string'));
            
            for i=1:4294967296
                senddata=[addr 4 0 0 0 35 255 255];
