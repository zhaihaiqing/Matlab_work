...
%         dt=datestr(datetime);
%         header2={dt,31,35};
%         xlswrite(fileID,header2,'Sheet1','A2');
        
        %fclose(fileID);
        
        senddata1=[addr1 4 0 0 0 52 255 255];
        senddata2=[addr2 4 0 0 0 52 255 255];
        senddata3=[addr3 4 0 0 0 52 255 255];
        senddata4=[addr4 4 0 0 0 52 255 255];
        for i=1:6553600000
