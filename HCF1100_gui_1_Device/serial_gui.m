...
% Last Modified by GUIDE v2.5 22-Aug-2019 09:42:25
...
%%
    ...
    rates=[4800 9600 19200 38400 57600 115200];              % 获取串口的波特率
    ...
    if strcmp(get(gco,'string'),'打开串口')
        try
            ...
            set(scom,'BytesAvailableFcnCount',109);       %接收缓冲区每收到N个字节时，触发回调函数
            ...
            senddata1=[60 4 0 0 0 52 255 255];
