...
close all;
clc;
aa1=textread('C:\Documents and Settings\xie\桌面\振动数据最新版\zd静止.TXT','%s');   %以符号的形式读入16进制文件    保存时是dlmwrite('filename.txt',a)
aa2=textread('C:\Documents and Settings\xie\桌面\振动数据最新版\zd静止平均.TXT','%s');
aa3=textread('C:\Documents and Settings\xie\桌面\振动数据最新版\zd震动平均.TXT','%s');
aa4=textread('C:\Documents and Settings\xie\桌面\振动数据最新版\zd静止平均重物.TXT','%s');
