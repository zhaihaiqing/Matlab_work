...
% Last Modified by GUIDE v2.5 24-Jun-2015 11:52:52
...
% --- Executes on button press in open_usart.
function open_usart_Callback(hObject, eventdata, handles)
% hObject    handle to open_usart (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global s;
global datas;
...
% --- Executes on button press in close_usart.
function close_usart_Callback(hObject, eventdata, handles)
% hObject    handle to close_usart (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
